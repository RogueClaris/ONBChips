...
function package_init(package) 
    package:declare_package_id("com.claris.card.IceCube")
    ...
    props.description = "Place an IceCube in front"
...
function card_create_action(actor, props)
    ...
    action.execute_func = function(self, user)
		...
		cube:register_status_callback(Hit.Breaking, function()
			cube:set_health(0)
		end)
		local continue_slide = false
		local saved_direction = Direction.None
		cube:set_health(200)
